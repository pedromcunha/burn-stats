          ...
          order.map((token, index) => {
            return (
              <div key={index} style={{"display": "flex", "alignItems": "center", "margin": "5vh", "justifyItems": "start"}}>
                ...
                <a href={"https://forgotten.market/0x521f9c7505005cfa19a8e5786a9c3c9c9f5e6f42/" + token} target="_blank" rel="noopener noreferrer">
                ...
                <div>
                <a href={"https://forgotten.market/0x251b5f14a825c537ff788604ea1b58e49b70726f/" + token} target="_blank" rel="noopener noreferrer">
